...
/**
 * The `StyAuthProvider` component is a React context provider that initializes the Strivacity SDK and provides its state and methods to the rest of the application.
 *
 ...
 * @param {SessionData | null} [props.session] - Optional session data to initialize the SDK with.
 * @param {React.ReactNode} props.children - The child components that will have access to the SDK context.
 *
 * @returns {JSX.Element} A React context provider that wraps its children and provides access to the Strivacity SDK.
 */
