...
/**
 * The `StyAuthProvider` component is a Preact context provider that initializes the Strivacity SDK and provides its state and methods to the rest of the application.
 *
 ...
 * @param {ComponentChildren} props.children - The child components that will have access to the SDK context.
 * @param {SessionData | null} [props.session] - Optional session data to initialize the SDK with.
 */
export function StyAuthProvider({ options, session, children }: StyAuthProviderProps): JSX.Element {
