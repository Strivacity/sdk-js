import type { LayoutWidget, Widget } from '@strivacity/sdk-preact';
...
// looks up its widget data by id in the current forms and picks the matching Preact component from the `widgets` map
