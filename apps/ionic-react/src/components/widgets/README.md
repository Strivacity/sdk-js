...
```tsx
import { LayoutWidget } from '@strivacity/sdk-react';
...
```tsx
import { StaticWidget } from '@strivacity/sdk-react';
...
```tsx
import { InputWidget } from '@strivacity/sdk-react';
...
```tsx
import { SubmitWidget } from '@strivacity/sdk-react';
...
```tsx
import { CheckboxWidget } from '@strivacity/sdk-react';
...
```tsx
import { DateWidget } from '@strivacity/sdk-react';
...
```tsx
import { PasswordWidget } from '@strivacity/sdk-react';
...
```tsx
import { PasscodeWidget } from '@strivacity/sdk-react';
...
```tsx
import { PhoneWidget } from '@strivacity/sdk-react';
...
```tsx
import { SelectWidget } from '@strivacity/sdk-react';
...
```tsx
import { MultiSelectWidget } from '@strivacity/sdk-react';
...
```tsx
import { LoadingWidget } from '@strivacity/sdk-react';
