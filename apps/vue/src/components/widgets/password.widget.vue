...
// const validator = computed(() => props.config.validator); // FIXME
...
<template>
	<div>
		...
		<input :id="config.id" :name="config.id" type="password" required size="1" @change="onChange($event)" @keydown.enter.stop="onKeyDown($event)" />
