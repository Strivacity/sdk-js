...
import { NativeFlowContext, createCredential } from '@strivacity/sdk-remix';
...
Both functions are imported from `@strivacity/sdk-remix` and handle the low-level WebAuthn protocol details, making it easy to integrate passkey authentication into your applications.
