import type { CustomNativeFlow } from './sdk/CustomNativeFlow';
...
export class AppComponent {
	...
	constructor(protected strivacityAuthService: StrivacityAuthService<CustomNativeFlow>) {
		...
		// Initial session fetch to determine authentication state on app load
		void this.strivacityAuthService.sdk.fetchSessionData();
	}
}
