...
import { EmbeddedFlow } from '@strivacity/sdk-core/flows/EmbeddedFlow';
import { Session } from '@strivacity/sdk-core/utils/Session';
import { CustomEmbeddedFlowHandler } from './CustomEmbeddedFlowHandler';

export class CustomEmbeddedFlow extends EmbeddedFlow {
	...
	override login(params: NativeParams = {}): CustomEmbeddedFlowHandler {
		this.dispatchEvent('loginInitiated', []);

		return new CustomEmbeddedFlowHandler(this, params);
	}

	override register(params: NativeParams = {}): CustomEmbeddedFlowHandler {
