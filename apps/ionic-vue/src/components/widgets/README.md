...
import { type NativeFlowContextValue, getCredential } from '@strivacity/sdk-vue';
...
import { type NativeFlowContextValue, createCredential } from '@strivacity/sdk-vue';
...
Both functions are imported from `@strivacity/sdk-vue` and handle the low-level WebAuthn protocol details, making it easy to integrate passkey authentication into your applications.
