...
export const defineTsConfig = (...configs) =>
	tsEslint.config(pluginJs.configs.recommended, ...tsEslint.configs.recommendedTypeChecked, ignoreConfig, baseConfig, vitestConfig, ...configs);
...
export const defineSolidConfig = (...configs) =>
	tsEslint.config(
		pluginJs.configs.recommended,
		...tsEslint.configs.recommendedTypeChecked,
		ignoreConfig,
